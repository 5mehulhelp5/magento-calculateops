...
namespace BredaBeds\CalculateOps\Catalog\Model\Product;
    ...
    public function afterSave()
    {
        ...
        if (is_array($values)) {
            foreach ($values as $value) {
                ...
                //ooedit 2021-11-22L commented this out because we had duplicate custom options in backend (no idea why it's here or what it does)
